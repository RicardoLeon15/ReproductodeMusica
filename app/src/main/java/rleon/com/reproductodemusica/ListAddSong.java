...
public class ListAddSong extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!(archivosMS.size()<0)){
            Log.i("prueba","Si entro varias veces");
            adapterList = new AdapterList(getContext(), archivosMS);
        ...
        view.findViewById(R.id.btnReturnList).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_listAddSong_to_Listas);
            }
        });
        return view;
    }
